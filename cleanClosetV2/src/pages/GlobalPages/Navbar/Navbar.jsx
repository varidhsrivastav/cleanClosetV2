...
var  openNav = ()=>{
    ...
    <nav className="navbar navbar-expand-sm navbar-light" onScroll={openNav}>
        <div className="container" data-aos="fade-down">
            <Link className="navbar-brand" to="/"> CleanCloset</Link>
            ...
            <div className="collaps navbar-collapse" id="navbarNav">
                <ul className="navbar-nav mx-auto">
                    <li className="nav-item text-white">
                        ...
                        <Link to="/ngo" className="nav-link"><span data-hover="Ngo">Add Ngo</span></Link>
                    </li>
                    <li className="nav-item">
                        <Link to="/donor" className="nav-link"><span data-hover="donate">Donate</span></Link>
                    </li>
                    <li className="nav-item">
                ...
                <ul className="navbar-nav ml-lg-5">
                      <Link to="/ngo" className="nav-link"><span data-hover="Add ngo">Add Ngo</span></Link>
                </ul>
            </div>
        </div>
    </nav>
